...
faq:
  - question: I finished the Solana track. What should I learn next?
    answer: The natural next step is the Ethereum track, where you write Solidity
      ...
      such as Jupiter's router or a Drift or Kamino vault, and build something
      of your own. Either path builds directly on what you already have.
  - question: Will the Solana knowledge from this course go out of date quickly?
    answer: No. The working knowledge you built, from how programs are stateless and
      accounts hold everything, to writing Anchor programs, composing them
      through CPI, and integrating Token-2022 extensions, is the foundation
      every Solana program you will read or write sits on, and it does not
      expire. It gets sharper the more you use it. Even if you move to Ethereum,
      ideas like its storage layout are easier to understand once you have
      already worked through rent and zero-copy on Solana.
---
