  ...
  return (
    <Sonner
      ...
      icons={{
        ...
        loading: <Loader2 className="h-4 w-4 shrink-0 animate-spin text-primary-foreground" aria-hidden />,
      }}
      toastOptions={{
        classNames: {
          ...
          loading: [
            ...
            '[&_[data-title]]:!text-primary-foreground [&_[data-description]]:!text-primary-foreground',
          ].join(' '),
          default: [
            toastShell,
