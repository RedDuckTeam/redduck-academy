...
interface TextProps
  extends
    Omit<HTMLAttributes<HTMLElement>, 'variant'>,
...
const textVariants = cva('text-black', {
  variants: {
    variant: {
      ...
      'caps-14': 'text-[14px] uppercase leading-[18px]',
      'caps-20': 'text-[20px] uppercase leading-[24px]',
      'caps-24': 'text-[24px] uppercase leading-[30px] font-medium',
      'subtitle-32': 'text-[32px] leading-[38px] font-medium uppercase',
      'subtitle-45': 'text-[45px] leading-[60px] font-medium uppercase',
      'title-80': 'text-[80px] leading-[96px] font-medium uppercase',
    },
  },
  defaultVariants: {
    variant: 'main-16',
