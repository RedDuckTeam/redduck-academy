...
export const SettingsCard = ({ title, children, className }: SettingsCardProps) => {
  return (
    <div className={cn('flex flex-col border border-border sm:p-7 gap-5', className)}>
...
export const SettingsCardRow = ({ label, children, className, labelClassName }: SettingsCardRowProps) => {
  return (
    <div
      className={cn(
        'flex sm:items-center gap-3 max-sm:flex-col py-4 first:pt-0 last:pb-0 border-b border-dashed border-border/50 last:border-b-0',
        className,
      )}
    >
