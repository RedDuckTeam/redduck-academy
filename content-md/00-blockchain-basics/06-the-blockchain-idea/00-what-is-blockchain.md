...
This gives you a tamper-evident sequence. Each block points back at the one before it via a hash. The whole structure is what gives the name "block chain" its first word and its second.
...
<svg viewBox="0 0 720 300" xmlns="http://www.w3.org/2000/svg" style="background:#e0deda; font-family: system-ui, sans-serif;">
